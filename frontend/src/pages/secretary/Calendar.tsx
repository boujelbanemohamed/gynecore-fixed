...
const SecretaryCalendar = () => {
  ...
  const handleSave = async () => {
    try {
      const data = { ...form, startTime: form.date + 'T' + form.startTime + ':00', endTime: form.date + 'T' + form.endTime + ':00' };
      if (editAppt) {
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 20 }}>
        ...
        <div className="card" style={{ padding: 16 }}>
          ...
          {!dayAppts.length ? <p style={{ color: '#999', fontSize: 13 }}>Aucun rendez-vous</p> : dayAppts.sort((a: any, b: any) => new Date(a.startTime).getTime() - new Date(b.startTime).getTime()).map((a: any) => (
